...
مواقع فضاء أنستازيا قائمة ومتاحة للاستخدام، والآن نعمل على تطوير تطبيقها الرسمي للهاتف. التطبيق لا يزال في بداياته، وهذا المستودع مخصص لشيفرته؛ أما شيفرة المواقع والخوادم فهي منفصلة عنه.
...
النسخة الحالية تعمل ويمكن تثبيتها، لكنها مخصصة للتجربة أثناء التطوير. ملف APK المتاح هو **نسخة Debug، وليس إصدارًا رسميًا مستقرًا**.

### تنزيل التطبيق

**[حمّل أحدث نسخة للتجربة — APK](dev/anastasia-space-dev.apk)**

الرابط يفتح ملف النسخة الحالية في المستودع. هذه نسخة للتجربة فقط؛ لم يصدر التطبيق بنسخته المستقرة بعد.
